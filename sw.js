const CACHE_NAME = 'smart-salon-v5';
...
// Role-based Push Notification Handling
self.addEventListener('push', (event) => {
  let data = { title: 'Smart Salon', body: 'নতুন একটি আপডেট আছে!' };
  ...
  const options = {
    ...
    actions: [
      { action: 'explore', title: 'অ্যাপ দেখুন' },
